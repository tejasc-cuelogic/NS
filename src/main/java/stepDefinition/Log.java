...
public class Log extends Common{
	...
	public void invalid_investor_details() throws Exception {
		try 
		{
			...
			String randomEmail = randomEmails();
	...
	public WebDriver valid_investor_details() throws Exception {
		try {
			...
			String randomStrings= randomString(8);
			log.pwd(d).click();
			d.manage().timeouts().implicitlyWait(30, TimeUnit.SECONDS);
			...
			log.zip.click();
			String randomPhone = randomPhone(10);
			randomPhone(10);
			...
			String randomssn = randomPhone(9);
			randomPhone(9);
			...
			log.net.click();
			String randomphone = randomPhone(6);
			randomPhone(6);
			log.net.sendKeys(randomphone);
			
			log.inco.click();
			String randomphone1 = randomPhone(6);
			randomPhone(6);
...
//		    d.manage().timeouts().implicitlyWait(60,TimeUnit.SECONDS) ;		   
		    ...
		    d.manage().timeouts().implicitlyWait(60,TimeUnit.SECONDS);
		    String randomphone2 = randomPhone(10);
		    randomPhone(6);
		    ...
		    log.taxId.click();
		    String randomphoneid = randomPhone(9);
		    randomPhone(9);
			...
			d.manage().timeouts().implicitlyWait(60, TimeUnit.SECONDS);
			log.zip.click();
			String randomPhones = randomPhone(10);
			randomPhone(5);
		    ...
		    String randomphoneids = randomPhone(9);
		    randomPhone(9);
			...
			String randomstrings = randomString(6);
			randomString(6);
